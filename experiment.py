...
from utils import calcCorr, preprocess, set_seed
from model import TMMP
...
def trainModel(args):
    ...
    for train_index, test_index in kf.split(trainData):
        trainData, trainLabel, testData, testLabel = trainData[train_index], trainLabel[train_index], trainData[test_index], trainLabel[test_index]
        ...
        model = TMMP(tasks=args.tasks).to(device)
        criterion = nn.L1Loss()
